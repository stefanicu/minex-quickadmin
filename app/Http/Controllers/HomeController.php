...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $integrated_solutions_industries = Industry::leftJoin('industry_translations','industries.id','=','industry_translations.industry_id' )
        ...
        $consultancy_references = Reference::leftJoin('reference_translations','references.id','=','reference_translations.reference_id' )
        ...
        $references_industries = Industry::leftJoin('industry_translations','industries.id','=','industry_translations.industry_id' )
            ->select('industries.id','industries.online','name','slug')
            ->where('locale','=',app()->getLocale())
            ->whereIn('industries.id',array(2,12,4,6))
            ->orderByRaw('FIELD(industries.id,2,12,4,6)')
        ...
        $references_references = Reference::leftJoin('reference_translations','references.id','=','reference_translations.reference_id' )
            ->select('references.id','references.online','name','slug')
            ->where('locale','=',app()->getLocale())
        ...
        return view('welcome', compact( 'hero', 'integrated_solutions', 'integrated_solutions_industries', 'consultancy', 'maintenance', 'references', 'about_us', 'contact_us','consultancy_references','references_industries','references_references'));
    }
}
