...
//                                                echo '<li><a class="d-block my-2">'.$application->name.',  '.$application->application_id.'-'.$application->oldid.', #'.$application->id.'</a></li>';
            ...
            <li class="nav-item">
                <a class="nav-link"
                   href="{{ url('') . '/' . app()->getLocale() . '#contact' }}">{{ trans('pages.contact')}}</a>
            </li>
        </ul>
        <form class="form-inline form-inline__menu my-2 ml-auto searchbox" method="get"
            ...
            <button class="btn my-2 my-sm-0 searchbox-submit" type="submit" id="searchbox" aria-label="Search Box">
                <svg class="menu-icon" version="1.1" xmlns="http://www.w3.org/2000/svg"
                     x="0px" y="0px" viewBox="0 0 100 100"
                     style="enable-background:new 0 0 100 100;" xml:space="preserve">
					<path fill="#ffffff"
                          d="M87.24,79.76L67.23,59.74c3.37-4.99,5.34-11,5.34-17.46C72.57,25.03,58.53,11,41.28,11C24.03,11,10,25.03,10,42.28c0,17.25,14.03,31.28,31.28,31.28c6.46,0,12.47-1.97,17.46-5.34l20.01,20.01C79.93,89.41,81.46,90,83,90s3.07-0.59,4.24-1.76C89.59,85.9,89.59,82.1,87.24,79.76z M22,42.28C22,31.65,30.65,23,41.28,23s19.28,8.65,19.28,19.28s-8.65,19.28-19.28,19.28S22,52.92,22,42.28z"></path>
				</svg>
            </button>
        </form>
