...
{{--                    <label class="form-check-label" for="visible">{{ trans('cruds.blog.fields.visible') }}</label>--}}
{{--                </div>--}}
{{--                @if($errors->has('visible'))--}}
{{--                    <span class="text-danger">{{ $errors->first('visible') }}</span>--}}
{{--                @endif--}}
{{--                <span class="help-block">{{ trans('cruds.blog.fields.visible_helper') }}</span>--}}
{{--            </div>--}}
            ...
            <div class="form-group">
                <label class="" for="image_text">{{ trans('cruds.blog.fields.image_text') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.blog.fields.image_text_helper') }}</span>
            </div>
