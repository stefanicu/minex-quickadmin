    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-iddHomes">
                    <thead>
                        <tr>
                            <th width="10">
...
<script>
  ...
  let table = $('.datatable-iddHomes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
