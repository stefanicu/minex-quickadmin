    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contacts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('how_about') ? 'is-invalid' : '' }}" type="text" name="how_about" id="how_about" value="{{ old('how_about', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('checkbox') ? 'is-invalid' : '' }}" type="text" name="checkbox" id="checkbox" value="{{ old('checkbox', '') }}">
