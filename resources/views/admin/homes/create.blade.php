    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.homes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('first_text') ? 'is-invalid' : '' }}" name="first_text" id="first_text">{{ old('first_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('quote') ? 'is-invalid' : '' }}" name="quote" id="quote">{!! old('quote') !!}</textarea>
                @if($errors->has('quote'))
