...
{{--            </div>--}}
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_img5') ? 'is-invalid' : '' }}" type="text" name="text_img5" id="text_img5" value="{{ old('text_img5', '') }}">
            ...
            <div class="row">
                <div class="form-group col-3">
                    ...
                    <input class="form-control {{ $errors->has('text_img1') ? 'is-invalid' : '' }}" type="text" name="text_img1" id="text_img1" value="{{ old('text_img1', '') }}">
                ...
                <div class="form-group col-3">
                    ...
                    <input class="form-control {{ $errors->has('text_img2') ? 'is-invalid' : '' }}" type="text" name="text_img2" id="text_img2" value="{{ old('text_img2', '') }}">
                ...
                <div class="form-group col-3">
                    ...
                    <input class="form-control {{ $errors->has('text_img3') ? 'is-invalid' : '' }}" type="text" name="text_img3" id="text_img3" value="{{ old('text_img3', '') }}">
                ...
                <div class="form-group col-3">
                    ...
                    <input class="form-control {{ $errors->has('text_img4') ? 'is-invalid' : '' }}" type="text" name="text_img4" id="text_img4" value="{{ old('text_img4', '') }}">
