    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="w-50 text-right">
                @if(array_key_exists(app()->getLocale(), config('panel.available_languages')) && $brand->translate(app()->getLocale()))
                    <a class="blue" href="{{ route('pages.'.app()->getLocale(), ['slug'=>$brand->slug]) }}" target="_blank">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.brands.update", [$brand->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('content') ? 'is-invalid' : '' }}" rows="200" name="content" id="content">{!! old('content', $brand->content) !!}</textarea>
                ...
                <div class="row">
                    <div class="form-group col-12 col-xl-4">
                        ...
                        <input class="form-control {{ $errors->has('call_to_action') ? 'is-invalid' : '' }}" type="text" name="call_to_action" id="call_to_action" value="{{ old('call_to_action', $brand->call_to_action ?? '') }}">
                    ...
                    <div class="form-group col-12 col-xl-8">
                        <label for="call_to_action_link">{{ trans('cruds.brand.fields.call_to_action_link') }}</label>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">{{ url('') . '/' . app()->getLocale() . '/' }}</span>
                            </div>
                            <input class="form-control {{ $errors->has('call_to_action_link') ? 'is-invalid' : '' }}" type="text" name="call_to_action_link" id="call_to_action_link" value="{{ old('call_to_action_link', $brand->call_to_action_link ?? '') }}">
                        </div>
                ...
                <form id="translateButtonAllForm" method="POST" class="" action="{{ route("admin.translation.languages") }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-check {{ $errors->has('online') ? 'is-invalid' : '' }}">
                            ...
                            <input type="hidden" name="model_translation" id="model_translation" value="brand_translations">
                            <input type="hidden" name="foreign_key" id="foreign_key" value="brand_id">
