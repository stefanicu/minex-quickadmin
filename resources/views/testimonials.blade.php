    ...
    <div class="container-fluid cover p-0">
        ...
        <figure class="d-flex align-items-center section--figure">
            <picture data-alt="Branduri">
                ...
                <img class="lozad img-fluid section--hero-img lazy-fade" srcset="{{ asset('/img/headers/testimoniale-xl.jpg') }}" alt="{{ trans('pages.testimonials') }}" data-loaded="true">
                <noscript>
                    <img class="img-fluid lozad" src="{{ asset('/img/headers/testimoniale-xl.jpg') }}" alt="{{ trans('pages.testimonials') }}">
                </noscript>
            </picture>
        </figure>
    </div>
