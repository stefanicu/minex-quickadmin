...
<footer class="d-flex py-2 px-4 justify-content-between align-items-center">
    ...
    <ul class="list-inline my-0 mr-auto ml-4">
        <li class="list-inline-item">
            <a href="https://www.linkedin.com/company/minex-group" aria-label="Linkedin Link" target="_blank" rel="noopener">
        ...
        <li class="list-inline-item">
            <a href="https://www.youtube.com/@minextv" aria-label="Youtube Link" target="_blank" rel="noopener">
        ...
        <li class="list-inline-item">
            <a href="https://x.com/MinexGroup" aria-label="X Link" target="_blank" rel="noopener">
                <svg class="social-ico social-ico--facebook" viewBox="0 0 24 24" xml:space="preserve">
                    <g>
        ...
        <li class="list-inline-item">
            <a href="https://www.facebook.com/MinexGroup/" aria-label="Facebook Link" target="_blank" rel="noopener">
    ...
    <p class="text-right my-0 m-button">
        <a href="{{ route('pages.'.app()->getLocale(),['slug'=>$gdprTranslation->slug]) }}">{{ trans('pages.gdpr_compliance') }}</a><br>&#169; {{ trans('pages.copyright') }}
    </p>
