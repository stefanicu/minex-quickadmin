...
INSERT INTO minexq.categories(id, online, oldid, oldgroupid, oldimage, oldproductid, oldproductimg, page_views)
SELECT * FROM (
     SELECT id, IF(online > 0, 1, 0) AS online, id AS oldid, id_gru AS oldgroupid, img_xl AS oldimage, id_pro AS oldproductid, img_pro AS oldproductimg, viz AS page_views
